...
ApplicationWindow {
    ...
    WorkerScript {
        ...
        onMessage: {
            if(messageObject.error && messageObject.error === true)
            {
                if(goeTimer.interval != 500)
                {
                    goeTimer.interval = 500
                }
            }
            ...
            else
            {
                ...
                if(messageObject.reports)
                {
                    ...
                    if(isnext)
                    {
                        if(playSound.volume != mainwindow.sound_volume)
                        {
